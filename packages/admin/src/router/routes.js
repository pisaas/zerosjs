    ...
    children: [
      { path: 't', name: 'app:act:topic', component: Parent,
        ...
        children: [
          ...
          { path: 'new', name: 'app:act:topic:new',
            component: load('acts/topics/views/edit'),
            meta: { title: '新建话题', hideInMenu: true, belongTo: 'app:act:topic:list' },
          },
          { path: 'edit', name: 'app:act:topic:edit',
            component: load('acts/topics/views/edit/edit.vue'),
            meta: { title: '编辑话题', hideInMenu: true, belongTo: 'app:act:topic:list' },
          },
